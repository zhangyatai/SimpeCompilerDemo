package com.yt.pay.unionPay.acp.demo;

import com.yt.pay.unionPay.acp.sdk.AcpService;
import com.yt.pay.unionPay.acp.sdk.LogUtil;
import com.yt.pay.unionPay.acp.sdk.SDKConfig;
...
public class Form05_6_4_Refund extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		data.put("backUrl", DemoBase.backUrl);               //后台通知地址，后台通知参数详见open.yt.pay.unionPay.com帮助中心 下载  产品接口规范  网关支付产品接口规范 退货交易 商户通知,其他说明同消费交易的后台通知
...
//		data.put("reqReserved", Base64.encodeBase64String("任意格式的信息都可以".toString().getBytes(DemoBase.encoding)));
		...
		//应答码规范参考open.yt.pay.unionPay.com帮助中心 下载  产品接口规范  《平台接入接口规范-第5部分-附录》
		if(!rspData.isEmpty()){
